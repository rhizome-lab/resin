...
//!
//! Provides GPU compute shader execution for image primitives defined in `resin-image`.
...
///
/// ```ignore
/// use rhizome_resin_gpu::{GpuContext, remap_uv_gpu};
/// use rhizome_resin_image::UvExpr;
///
...
///
/// ```ignore
/// use rhizome_resin_gpu::{GpuContext, map_pixels_gpu};
/// use rhizome_resin_image::ColorExpr;
///
/// let ctx = GpuContext::new()?;
/// let input = load_texture(&ctx, "image.png")?;
///
